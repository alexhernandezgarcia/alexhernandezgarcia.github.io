...
name: indaba-ml-for-science-aug25
class: title, middle
...
.turquoise[[Deep Learning Indaba (Virtual)](https://deeplearningindaba.com/2025/virtual-indaba/) · Africa and the world · August 20th 2025]
...
.conclusion[There are infinitely many conceivable materials, $10^{60}$ drug-like molecules. Are predictive models enough?]
]
...
* Limited data: only about 200 K known inorganic materials, but combinatorially many possible stable materials (for reference: more than a billion molecules are known)
...
[Hands-on tutorial about the gflownet library and Crystal-GFN](https://colab.research.google.com/drive/128wF6-56mCdvo38pl0m9dPiSm6We7CTe?usp=sharing)

---

name: gflownets-tutorial-mar25
class: title, middle
