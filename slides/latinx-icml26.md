...
.turquoise[[LatinX in AI Workshop, ICML](https://icml.cc/virtual/2026/affinity-event/54097) · Seoul · July 7th 2026]
...
##  GFlowNets extensions and resources
### Synthesizable molecular generation via soft constraints

A contrastive loss term enables the introduction of soft constraints, such as synthesizability for molecular generation.

.center[![:scale 100%](../assets/images/slides/antibiotics/s3gfn_core.png)]
