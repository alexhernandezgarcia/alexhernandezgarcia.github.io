...
title: "Generative and active learning with GFlowNets for scientific discovery"
---

name: nagoya-mlds-apr25
class: title, middle
...
.turquoise[[Nagoya-MLDS Lab](https://www.mlds.mae.nagoya-u.ac.jp/index.html) · Nagoya University · April 28th 2025]
...
- $f$: Oracle, cost per evaluation 100,000 円.
...
Example: "incredibly hard" Tetris problem: find arrangements of Tetris pieces that optimise an .highlight2[unknown function $f$].
- $f$: Oracle, cost per evaluation 100,000 円.
- $f\_1$: Slightly inaccurate oracle, cost 10,000 円.
- $f\_2$: Noisy but informative oracle, cost 100 円.
