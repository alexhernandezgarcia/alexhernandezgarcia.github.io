...
title: "Multi-fidelity active learning and generative models for science"
---

name: nrcan-mila-dec25
class: title, middle

## Multi-fidelity active learning and generative models for science

Alex Hernández-García (he/il/él)

.turquoise[Mila/NRCAN Alignment on Research Themes · December 8th 2025]
...
- Drug discovery
    ...
    - Molecular 3D modelling (conformations)
- Materials discovery
    - Electrocatalysts for sustainability applications
...
- Generative models (GFlowNets)
- Domain-inspired predictive models
