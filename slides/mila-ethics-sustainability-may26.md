...
name: mila-ethics-sustainability-may26
class: title, middle
...
.turquoise[Summer School in Responsible AI and Human Rights · Ciudad de México · May 22nd 2026]
...
.center[
<a href="https://www.obvia.ca/"><img src="../assets/images/slides/logos/obvia_gray.png" alt="Obvia - Observatoire international sur les impacts sociétaux de l'IA et du numérique" style="height: 2.5em"></a>
&nbsp&nbsp&nbsp&nbsp
...
.context30[The scale of AI is a defining factor of the energy consumption.]

.center[
<figure>
	<img src="../assets/images/slides/ai-env-impact/trends_ai_flops.png" alt="Trends in AI FLOPS of notable models" style="width: 50%">
  .smaller[<figcaption>The size of the biggest AI models, measured as the number of operations, has quadrupled every year. Source: <a href="https://en.wikipedia.org/wiki/Large_language_model">Wikipedia</a></figcaption>]
</figure>
]
...
.conclusion[The large-scale deployment of huge models poses the main problem in a context of climate crisis.]
...
- Luccioni, Strubell and Crawford. [From efficiency gains to rebound effects: The problem of Jevons’ paradox in AI’s polarized environmental debate](https://dl.acm.org/doi/full/10.1145/3715275.3732007), FAccT, 2025.
]
...
- Big tech has a disproportionate and growing influence in AI research and development.
- This influence allows to largely set the agenda, for example by pushing for large-scale and general-purpose systems.
- These directions, motivated by profit seeking, are fundamentally at odds with the responsible, ethical, and sustainable development of AI.

.references[
Hernandez-Garcia, Volokhova, Williams, Shaaban Kabakibo, Teng. [Irresponsible AI: big tech’s influence on AI research and associated impacts](https://arxiv.org/abs/2512.03077), ICML, 2026
]
...
## The implicated _scientist_

.left-column[<img src="../assets/images/slides/implicated-subject/drawing_implication.png" width="90%">]
...
.references[
Volokhova, Hernandez-Garcia. [The implicated scientist: on the role of AI researchers in the development of weapons systems](https://arxiv.org/abs/2604.18380), AI for Peace workshop, ICLR, 2026
]
...
.left-column[<img src="../assets/images/slides/implicated-subject/drawing.png" width="90%">]
...
In my opinion, considering myself as an implicated subject is helpful for developing action plans and allowing myself to .highlight1[adjust my level of involvement].
...
.conclusion[Implication means responsibility but also the possibility of changing the situation.]
