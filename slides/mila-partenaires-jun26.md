...
title: "Towards designing functional materials with GFlowNets"
---

name: mila-partenaires-jun26
class: title, middle

### Towards designing functional materials with GFlowNets

Alex Hernández-García (he/il/él)

.turquoise[Symposium des partenaires · Mila · June 3th 2026]
...
.right-column-66[<br>.center[![:scale 90%](../assets/images/slides/mfal/molecules_ea_5.png)]]
...
## Example application
### Design of novel lithium electrolytes with high ionic conductivity
...
## Crystal generation with machine learning
### The prevalent denoising diffusion approach

- Most current methods rely on denoising diffusion models trained on existing data, with limited potential for _discovery_.
...
.center[![:scale 80%](../assets/images/slides/crystals/mattergen_denoising.png)]
...
- As a GFlowNet, Crystal-GFN is _data-agnostic_, and is trained itself with a guiding reward function that can be any property.

.center[![:scale 50%](../assets/images/slides/drugs/gfn_molecules.png)]

.references[Jain et al. [GFlowNets for AI-Driven Scientific Discovery](https://pubs.rsc.org/en/content/articlelanding/2023/dd/d3dd00002h). Digital Discovery, Royal Society of Chemistry, 2023.]
...
- .alpha50[Electronic band gap [eV] (squared distance to a target value, 1.34 eV), via a pre-trained machine learning model: relevant in photovoltaics, for instance.]
...
Alex Hernández-García, Félix Therrien, Divya Sharma, Dounia Shaaban Kabakibo, Lena Podina...
...
GFlowNet library: [github.com/alexhernandezgarcia/gflownet](https://github.com/alexhernandezgarcia/gflownet)
