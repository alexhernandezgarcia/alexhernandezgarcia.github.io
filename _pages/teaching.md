...
From August to December 2026, I am teaching [_GFlowNets: Sampling as sequential decision making_]({{ site.url }}/gflownets) at the [Université de Montréal](https://www.umontreal.ca/). A (nearly complete) record of my main teaching activity is given below.
