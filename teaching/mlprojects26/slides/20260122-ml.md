...
À la différence des sessions précédentes, cette classe est essentiellement un cours théorique, mais qui met l'accent sur les questions et réponses, et sur des aspects pratiques.

The .highlight1[goal] is that by the end of the class:

* Vous rafraîchissez vos connaissances fondamentales en matière d'apprentissage automatique et vous vous préparez à les mettre en pratique.
* Vous consolidez et approfondissez certains concepts fondamentaux tels que la généralisation.
* Vous avez passé en revue certains erreurs courantes.
* Vous découvrez des astuces ou des bonnes pratiques en matière d'apprentissage automatique.
* Vous avez la possibilité de poser des questions.
* Vous voyez les compétences requises pour suivre ce cours.
