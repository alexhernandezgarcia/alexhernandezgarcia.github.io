...
name: 20260108-introduction
class: title, middle

## IFT 3710/6759
## Projets (avancés) en apprentissage automatique

#### .gray224[8 janvier 2026 - Session 1]
...
Ce cours est offert aux étudiant·e·s de premier cycle (IFT 3710) et étudiant·e·s de cycle supérieur (IFT 6759). Les étudiant·e·s de cycle supérieur peuvent choisir entre une version française (Section A, ici) et une version anglaise ([Section B, avec Prof. Noam Aigerman](https://studium.umontreal.ca/enrol/index.php?id=312456)).
...
.highlight1[A la fin du cours], on attend de vous que vous soyez capable de :
...
* Les lundis, 10:30-12:30 - Pav. Roger-Gaudry
* Les jeudis, 10:30-12:30 - Pav. André Aisenstadt
...
* .highlight1[Communication avec l'instructeur] : courriel ([alejandro.hernandez.garcia@umontreal.ca](mailto:alejandro.hernandez.garcia@umontreal.ca))
    - Si votre courriel peut intéresser d'autres étudiant·e·s ou si elles peuvent avoir une réponse, veuillez utiliser le forum de StudiUM à la place.
    - Si vous m'envoyez un courriel personel, s.v.p. mettez le code `[PROJETSML]` ou `[MLPROJECTS]` dans le sujet.
...
* Rencontres avec les instructeurs, pour évaluer à la fois les progrès et le fonctionnement de l'équipe.
...
* Découverte des matériaux et prédiction des propriétés
* Modélisation de séquences biologiques (ADN, ARN, protéines)
...
* Prévision anticipée des séismes
* ...
...
.context[Lundi 12 janvier, 10h30-12h30]
