...
#SBATCH --output=/scratch/<username>/logs/slurm-%j-%x.out   # Output file (CHANGE <username>)
#SBATCH --error=/scratch/<username>/logs/slurm-%j-%x.error  # Error file (CHANGE <username>)
