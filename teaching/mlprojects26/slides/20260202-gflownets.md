...
name: 20260202-gflownets
class: title, middle

## IFT 3710/6759
## Projets (avancés) en apprentissage automatique

#### .gray224[2 février 2026 - Session 8]
...
La première partie de la séance sera un cours théorique, la deuxième partie sera une démonstration pratique.

L'.highlight1[objectif] est qu’à la fin de la séance : 

* Vous comprenez pourquoi les modèles génératifs peuvent avoir un impact sur les découvertes scientifiques et la conception technique.
* Vous obtenez une vue d'ensemble des défis auxquels sont confrontés les modèles génératifs traditionnels dans les applications pratiques.
* Vous comprenez comment les réseaux de flux génératifs (GFlowNets) peuvent relever certains de ces défis.
* Vous pouvez expliquer les intuitions fondamentales et certains détails des GFlowNets.
* Vous pouvez commencer à former et à tester GFlowNets à l'aide des bases de code existantes.
...
.conclusion[Not enough if the search space is very large ($10^{60}$ drug-like molecules)]
]
...
And a state by a list of indices. For example, the word UDEM:

```python
udem = [21, 4, 5, 13, 0, 0, 0]
```
...
* Hydra-based configuration, WandB, etc.
...
* Mila AI4Science et al. [Crystal-GFN: sampling crystals with desirable properties and constraints](https://arxiv.org/abs/2310.04925). AI4Mat, NeurIPS 2023.
* Volokhova, Koziarski et al. [Towards equilibrium molecular conformation generation with GFlowNets](https://arxiv.org/abs/2310.14782). Digital Discovery, 2023.
