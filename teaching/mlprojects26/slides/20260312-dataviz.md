...
title: IFT 3710/6759 - Visualisation des données
---

name: 20260312-dataviz
class: title, middle

## IFT 3710/6759
## Projets (avancés) en apprentissage automatique

#### .gray224[12 mars 2026 - Session 9]
...
Ce cours sera un mélange de théorie et de démonstration pratique.

L'.highlight1[objectif] est qu’à la fin de la séance : 

* Vous connaissez les principes fondamentaux de la visualisation des données.
* Vous connaissez certains des ingrédients qui contribuent à une _bonne_ visualisation des données.
* Vous connaissez certains des ingrédients qui contribuent à une _mauvaise_ visualisation des données.

--

* L'objectif de cette session _n'est pas_ de vous enseigner comment utiliser des outils de visualisation spécifiques.
...
<br>
.highlight1[What are the underlying data represented by this bar plot?]

.center[<img src="../../../assets/images/teaching/mlprojects/dataviz/barplots1_left.png" alt="Many different datasets can lead to the same bar graph" style="width:90%"/>]
...
.center[<img src="../../../assets/images/teaching/mlprojects/dataviz/climategan_fig5.png" alt="ClimateGAN, Fig. 5" style="width:100%"/>]
...
.center[<img src="../../../assets/images/teaching/mlprojects/dataviz/climategan_fig6.png" alt="ClimateGAN, Fig. 6" style="width:100%"/>]
