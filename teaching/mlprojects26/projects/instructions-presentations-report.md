...
Les présentations auront lieu en classe à l'heure habituelle de la session et de la salle, pendant les trois dernières séances de cours :
...
Les instructions ci-dessus sont héritées des directives pour les soumissions de [NeurIPS 2025](https://media.neurips.cc/Conferences/NeurIPS2025/Styles.zip). Si vous avez de l'expérience avec LaTeX ou si vous êtes prêt à apprendre, vous êtes fortement encouragé à utiliser le modèle LaTeX de NeurIPS 2022 ou le modèle [`latex-simple`](https://github.com/alexhernandezgarcia/latex-simple) (plus simple et crée par l'instructeur), car ils vous permettront de vous concentrer sur le contenu plutôt que sur le format tout en produisant un document bien formaté. Si vous n'avez pas beaucoup d'expérience avec LaTeX, vous trouverez peut-être [Overleaf](https://www.overleaf.com/) utile.
