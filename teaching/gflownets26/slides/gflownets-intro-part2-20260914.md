...
title: IFT 6760B A26 - Introduction to GFlowNets II
---

name: gflownets-intro-part2-20260914
class: title, middle

## GFlowNets: Sampling as sequential decision making
### IFT 6760B A26

#### .gray224[September 14th - Session 4]
...
- Finalise the introduction of GFlowNets:
    - Show that a policy based on "future rewards" does not not enable correct sampling
    - Flow networks
...
- We will show how sampling is incorrect if multiple trajectories exist for a single sample.
...
- Show a set of basic empirical results to demonstrate that GFlowNets work as expected.
